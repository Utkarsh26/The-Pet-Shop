...
cartApp.controller("addToCartCtrl", function ($scope, $http){
    ...
    $scope.removeItemFromCart = function (itemId) {
    	$http.get('http://localhost/The_Pet_Shop/usercart/cart/removeItem/'+itemId).success(function (data) {
    ...
    $scope.addItemToCart = function (itemId) {
        ...
        $http.post('http://localhost/The_Pet_Shop/usercart/cart/addItem/'+itemId).success(function () {
    ...
    $scope.refreshCartItems = function () {    	
        $http.get('http://localhost/The_Pet_Shop/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
           $scope.cart=data;
        });
    };
    ...
    $scope.clearCartItems = function () {
    	$http['delete']('http://localhost/The_Pet_Shop/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data) {$scope.refreshCartItems()});
    };
});